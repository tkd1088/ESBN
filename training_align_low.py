...
result_path = '/data/tkd1088/result/hdr_transfer/result_190510_1_low'
if not os.path.exists(result_path):
  os.mkdir(result_path)
ckpt_path = '/data/tkd1088/result/hdr_transfer/ckpt_190510_1_low'
...
with tf.Session() as sess:
    ...
    for i in range(start_i+1, iteration+1):
        ...
        if i % step_test_save == 0:
            ...
            #result3 = np.concatenate((img_input_high, img_recon_high, img_gt_high), axis=0)
